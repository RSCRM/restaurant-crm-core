...
public class UpdateLicenseRequest {
    ...
    /**
     * If client sends this field, service must match it with current value.
     * If different → reject with LICENSE_CODE_IMMUTABLE.
     */
    String code;
    ...
    @NotNull(message = "LICENSE_STATUS_REQUIRED")
