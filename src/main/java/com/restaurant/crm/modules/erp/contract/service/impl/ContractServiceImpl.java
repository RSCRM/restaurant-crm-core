package com.restaurant.crm.modules.erp.contract.service.impl;
...
import com.restaurant.crm.modules.erp.contract.mapper.LicenseContractMapper;
import com.restaurant.crm.modules.erp.shared.repository.LicenseContractRepository;
...
public class ContractServiceImpl implements ContractService {
    ...
    public PagingResponse<LicenseInfoResponse> getMyLicenseInfos(PagingRequest request) {
        ...
        Page<LicenseContract> licensePage = licenseContractRepository.findAllByOrganization_OwnerId(
                ownerId,
                pageable
        );
    ...
    public LicenseInfoResponse getLicenseInfoByOrganization(String organizationId) {
        LicenseContract licenseContract = licenseContractRepository
                .findFirstByOrganization_IdAndOrganization_OwnerIdOrderByCreatedAtDesc(
                        organizationId,
                        getCurrentOwnerId())
