...
import com.restaurant.crm.modules.erp.constants.organization_branch.OrganizationBranchConstants;
import com.restaurant.crm.modules.erp.enums.BranchStatus;
...
public class OrganizationBranch extends BaseEntity {
    ...
    @Size(min = OrganizationBranchConstants.MIN_CHARS_BRANCH_NAME,
