...
public class BranchManagerController {
    ...
    @PostMapping
    @PreAuthorize("hasAuthority('" + StartDefinedPermission.BRANCH_MANAGER_CREATE + "')")
    ...
    @GetMapping
    @PreAuthorize("hasAuthority('" + StartDefinedPermission.BRANCH_MANAGER_VIEW + "')")
    ...
    @PreAuthorize("hasAuthority('" + StartDefinedPermission.BRANCH_MANAGER_UPDATE + "')")
    ...
    @PreAuthorize("hasAuthority('" + StartDefinedPermission.BRANCH_MANAGER_DELETE + "')")
