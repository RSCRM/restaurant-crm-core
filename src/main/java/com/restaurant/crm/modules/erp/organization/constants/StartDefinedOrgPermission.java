...
public class StartDefinedOrgPermission {
    ...
    // ===== INVENTORY =====
    public static final String INVENTORY_CATEGORY_VIEW = "INVENTORY_CATEGORY_VIEW";
    public static final String INVENTORY_CATEGORY_MANAGE = "INVENTORY_CATEGORY_MANAGE";
