...
public enum ErrorCode {
        ...
        ATTENDANCE_QR_GENERATION_FAILED("ATT_1007", "Attendance QR generation failed",
        ...
        SCHEDULE_TIME_RANGE_INVALID("SCHEDULE_1003", "Schedule start time must be before end time",
                        HttpStatus.BAD_REQUEST),
        ...
        ORGANIZATION_BRANCH_MANAGER_EXISTS("BRANCH_1001", "Manager is already assigned to another branch",
                        HttpStatus.BAD_REQUEST),
        ...
        BRANCH_MANAGER_ALREADY_ASSIGNED("BRANCH_MANAGER_1001", "Branch manager is already assigned to another branch",
                        HttpStatus.BAD_REQUEST),
        ...
        ALLOCATION_INVALID_PERCENT("ALLOC_1003", "Allocation percent must be between 1 and 100",
                        HttpStatus.BAD_REQUEST),
        // ==== BOOKING ERRORS ====
        BOOKING_NOT_FOUND("BOOKING_1000", "Booking not found", HttpStatus.NOT_FOUND),
        BOOKING_TIME_MUST_BE_FUTURE("BOOKING_1001", "Booking time must be in the future", HttpStatus.BAD_REQUEST),
        ...
        COMBO_ITEM_PRODUCT_BRANCH_MISMATCH("MENU_1042", "Product does not belong to the combo branch",
                        HttpStatus.BAD_REQUEST),
        COMBO_ITEM_OPTIONS_MISMATCH("MENU_1043", "Must pick exactly one option per modifier group of the product",
                        HttpStatus.BAD_REQUEST),
        ...
        RESTAURANT_TABLE_NUMBER_EXISTS("TABLE_1006", "Table number already exists in this area",
                        HttpStatus.BAD_REQUEST),
        ...
        ORDER_ITEM_STATUS_NOT_MODIFIABLE("ORDER_1009", "Order item status does not allow this modification",
                        HttpStatus.BAD_REQUEST),
        ORDER_ITEM_MODIFIER_NOT_FOUND("ORDER_1010", "Order item modifier not found", HttpStatus.NOT_FOUND),
        ORDER_STATUS_NOT_MODIFIABLE("ORDER_1011", "Only pending orders can be modified by staff",
                        HttpStatus.BAD_REQUEST),
        ORDER_ALREADY_PAID("ORDER_1012", "Order has already been paid", HttpStatus.BAD_REQUEST),
        ORDER_ITEM_ALREADY_ACCEPTED("ORDER_1013", "Order item has already been accepted by another chef",
                        HttpStatus.BAD_REQUEST),
        ORDER_ITEM_INVALID_STATUS_TRANSITION("ORDER_1014", "Invalid status transition for order item",
                        HttpStatus.BAD_REQUEST),
        ORDER_ITEM_NOT_PREPARED_BY_YOU("ORDER_1015", "You are not the chef who accepted this order item",
                        HttpStatus.BAD_REQUEST),
        ORDER_ITEM_CANCEL_REASON_REQUIRED("ORDER_1016", "Reason is required when cancelling order item",
                        HttpStatus.BAD_REQUEST),
    ...
    INVENTORY_INVALID_TRANSACTION_TYPE_DIRECTION("INV_TX_1004", "Invalid inventory transaction direction", HttpStatus.BAD_REQUEST),
        ...
        VOUCHER_DISCOUNT_INVALID("LOY_1009", "Voucher discount percent must be between 1 and 100",
                        HttpStatus.BAD_REQUEST),
        ...
        LICENSE_LOCKED_CANNOT_ISSUE("SUB_1003", "License is locked, cannot issue new subscription",
                        HttpStatus.CONFLICT),
        ...
        TQR_TABLE_SESSION_EXISTS("TQR_1011", "Table already has an active session, ask the owner for the group QR",
                        HttpStatus.CONFLICT),
        ...
        OTP_MAX_ATTEMPTS("OTP_1002", "Too many wrong OTP attempts, phone temporarily locked",
        ...
        OTP_TABLE_RATE_LIMIT("OTP_1005", "Too many OTP requests for this table, try again later",
                        HttpStatus.TOO_MANY_REQUESTS),
        ...
        // ==== VOUCHER CODE ERRORS ====
        VOUCHER_CODE_CANNOT_BE_REDEEMED_BY_POINTS("VOUCHER_1001", "Voucher code cannot be redeemed by points",
                        HttpStatus.BAD_REQUEST),
        VOUCHER_USAGE_LIMIT_EXCEEDED("VOUCHER_1002", "Mã ưu đãi đã hết số lượt sử dụng", HttpStatus.BAD_REQUEST),
        VOUCHER_CODE_INVALID_OR_NOT_FOUND("VOUCHER_1003", "Mã ưu đãi không tồn tại hoặc không hợp lệ",
                        HttpStatus.BAD_REQUEST),
                        ;
