...
INSERT INTO categories (category_id, version, branch_id, category_name, description, display_order, created_at, updated_at) VALUES
    ('cat00000-0000-0000-0000-000000000101', 0, 'e0000000-0000-0000-0000-000000000001', 'Phở & Bún',     'Các món Phở & Bún truyền thống Việt Nam', 1, NOW(), NOW()),
    ('cat00000-0000-0000-0000-000000000102', 0, 'e0000000-0000-0000-0000-000000000001', 'Cơm',           'Các món cơm Việt Nam',                     2, NOW(), NOW()),
...
INSERT INTO products (product_id, version, branch_id, category_id, product_name, description, price, image_url, status, requires_preparation, created_at, updated_at) VALUES
    ('prd00000-0000-0000-0000-000000000101', 0, 'e0000000-0000-0000-0000-000000000001', 'cat00000-0000-0000-0000-000000000101', 'Phở Bò Tái',            'Phở bò tái truyền thống với nước dùng đậm đà',             55000.00, NULL, 'AVAILABLE', true,  NOW(), NOW()),
    ('prd00000-0000-0000-0000-000000000102', 0, 'e0000000-0000-0000-0000-000000000001', 'cat00000-0000-0000-0000-000000000101', 'Phở Bò Chín',           'Phở bò chín mềm nước dùng xương hầm',                     55000.00, NULL, 'AVAILABLE', true,  NOW(), NOW()),
    ('prd00000-0000-0000-0000-000000000103', 0, 'e0000000-0000-0000-0000-000000000001', 'cat00000-0000-0000-0000-000000000101', 'Phở Gà Đặc Biệt',       'Phở gà ta thịt đùi xé phay kèm trứng non',                65000.00, NULL, 'AVAILABLE', true,  NOW(), NOW()),
    ('prd00000-0000-0000-0000-000000000104', 0, 'e0000000-0000-0000-0000-000000000001', 'cat00000-0000-0000-0000-000000000101', 'Bún Bò Huế',            'Bún bò Huế cay nồng đặc trưng miền Trung',                60000.00, NULL, 'AVAILABLE', true,  NOW(), NOW()),
    ('prd00000-0000-0000-0000-000000000005', 0, 'e0000000-0000-0000-0000-000000000001', 'cat00000-0000-0000-0000-000000000101', 'Phở Đặc Biệt Đặc Ruột', 'Phở đặc biệt đầy đủ: tái, chín, gầu, gân, sách',         75000.00, NULL, 'AVAILABLE', true,  NOW(), NOW())
    ON CONFLICT (branch_id, product_name) DO NOTHING;

-- Phở Việt - Chi nhánh Q1: Cơm
INSERT INTO products (product_id, version, branch_id, category_id, product_name, description, price, image_url, status, requires_preparation, created_at, updated_at) VALUES
    ('prd00000-0000-0000-0000-000000000006', 0, 'e0000000-0000-0000-0000-000000000001', 'cat00000-0000-0000-0000-000000000102', 'Cơm Tấm Sườn Nướng',    'Cơm tấm sườn nướng than hoa, chả, bì, trứng',            45000.00, NULL, 'AVAILABLE', true,  NOW(), NOW()),
    ('prd00000-0000-0000-0000-000000000007', 0, 'e0000000-0000-0000-0000-000000000001', 'cat00000-0000-0000-0000-000000000102', 'Cơm Gà Chiên Giòn',     'Cơm gà chiên giòn sốt mắm tỏi',                           50000.00, NULL, 'AVAILABLE', true,  NOW(), NOW())
    ON CONFLICT (branch_id, product_name) DO NOTHING;
...
INSERT INTO modifier_groups (modifier_group_id, version, product_id, group_name, description, min_selection, max_selection, created_at, updated_at) VALUES
    ('mg000000-0000-0000-0000-000000000001', 0, 'prd00000-0000-0000-0000-000000000101', 'Chọn Size',     'Chọn size phần ăn',       1, 1, NOW(), NOW()),
    ('mg000000-0000-0000-0000-000000000002', 0, 'prd00000-0000-0000-0000-000000000101', 'Topping Thêm',  'Thêm topping cho bát phở', 0, 3, NOW(), NOW())
    ON CONFLICT (modifier_group_id) DO NOTHING;

-- Phở Gà Đặc Biệt: Chọn size
INSERT INTO modifier_groups (modifier_group_id, version, product_id, group_name, description, min_selection, max_selection, created_at, updated_at) VALUES
    ('mg000000-0000-0000-0000-000000000003', 0, 'prd00000-0000-0000-0000-000000000103', 'Chọn Size',     'Chọn size phần ăn',       1, 1, NOW(), NOW())
    ON CONFLICT (modifier_group_id) DO NOTHING;

-- Bún Bò Huế: Chọn cay
INSERT INTO modifier_groups (modifier_group_id, version, product_id, group_name, description, min_selection, max_selection, created_at, updated_at) VALUES
    ('mg000000-0000-0000-0000-000000000004', 0, 'prd00000-0000-0000-0000-000000000104', 'Mức Độ Cay',    'Chọn mức độ cay',         1, 1, NOW(), NOW())
    ON CONFLICT (modifier_group_id) DO NOTHING;
