...
INSERT INTO products (product_id, version, branch_id, category_id, product_name, description, price, image_url, status, requires_preparation, created_at, updated_at) VALUES
                                                                                                                                                                          ...
                                                                                                                                                                          ('prd00000-0000-0000-0000-000000000102', 0, 'e0000000-0000-0000-0000-000000000001', 'cat00000-0000-0000-0000-000000000001', 'Phở Bò Chín',           'Phở bò chín mềm nước dùng xương hầm',                     55000.00, NULL, 'AVAILABLE', true,  NOW(), NOW()),
                                                                                                                                                                          ...
                                                                                                                                                                          ('prd00000-0000-0000-0000-000000000104', 0, 'e0000000-0000-0000-0000-000000000001', 'cat00000-0000-0000-0000-000000000001', 'Bún Bò Huế',            'Bún bò Huế cay nồng đặc trưng miền Trung',                60000.00, NULL, 'AVAILABLE', true,  NOW(), NOW()),
...
INSERT INTO products (product_id, version, branch_id, category_id, product_name, description, price, image_url, status, requires_preparation, created_at, updated_at) VALUES
                                                                                                                                                                          ('prd00000-0000-0000-0000-000000000008', 0, 'e0000000-0000-0000-0000-000000000001', 'cat00000-0000-0000-0000-000000000002', 'Trà Đá',                 'Trà đá ướp hoa lài ướp lạnh',                              5000.00, NULL, 'AVAILABLE', false, NOW(), NOW()),
--    ('prd00000-0000-0000-0000-000000000004', 0, 'e0000000-0000-0000-0000-000000000001', 'cat00000-0000-0000-0000-000000000002', 'Nước Cam Ép',            'Cam sành ép tươi 100% nguyên chất',                       25000.00, NULL, 'AVAILABLE', false, NOW(), NOW()),
                                                                                                                                                                          ('prd00000-0000-0000-0000-000000000010', 0, 'e0000000-0000-0000-0000-000000000001', 'cat00000-0000-0000-0000-000000000002', 'Cà Phê Sữa Đá',          'Cà phê sữa đá pha phin truyền thống',                     20000.00, NULL, 'AVAILABLE', false, NOW(), NOW()),
                                                                                                                                                                          ('prd00000-0000-0000-0000-000000000011', 0, 'e0000000-0000-0000-0000-000000000001', 'cat00000-0000-0000-0000-000000000002', 'Bia Tiger',              'Bia Tiger lon 330ml',                                      25000.00, NULL, 'AVAILABLE', false, NOW(), NOW())
    ON CONFLICT (branch_id, product_name) DO NOTHING;
...
INSERT INTO modifier_groups (modifier_group_id, version, product_id, group_name, description, min_selection, max_selection, created_at, updated_at) VALUES
    ('mg000000-0000-0000-0000-000000000003', 0, 'prd00000-0000-0000-0000-000000000002', 'Chọn Size',     'Chọn size phần ăn',       1, 1, NOW(), NOW())
    ON CONFLICT (modifier_group_id) DO NOTHING;
