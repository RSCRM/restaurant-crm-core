...
('p0000000-0000-0000-0000-000000000013', 0, 'ATTENDANCE_QR_DISPLAY', NOW(), NOW()),
('p0000000-0000-0000-0000-000000000014', 0, 'ATTENDANCE_SELF_WRITE', NOW(), NOW()),
('p0000000-0000-0000-0000-000000000015', 0, 'ATTENDANCE_SELF_READ', NOW(), NOW()),
('p0000000-0000-0000-0000-000000000013', 0, 'PROFILE_SELF_UPDATE', NOW(), NOW()),
('p0000000-0000-0000-0000-000000000014', 0, 'EMPLOYEE_ADD', NOW(), NOW()),
('p0000000-0000-0000-0000-000000000015', 0, 'EMPLOYEE_UPDATE', NOW(), NOW()),
...
ON CONFLICT DO NOTHING;
-- Active shift for UC-CM-06 check-in/check-out testing
INSERT INTO shift_assignments (id, version, employee_id, branch_id, work_date, start_at, end_at, created_at, updated_at) VALUES
('sa000000-0000-0000-0000-000000000009', 0, 'f0000000-0000-0000-0000-000000000009', 'e0000000-0000-0000-0000-000000000001', CURRENT_DATE, NOW() - INTERVAL '4 hours', NOW() + INTERVAL '4 hours', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Personal schedule for UC-CM-07 testing
INSERT INTO work_schedules (id, version, employee_id, branch_id, work_date, start_time, end_time, note, created_at, updated_at) VALUES
('ws000000-0000-0000-0000-000000000001', 0, 'f0000000-0000-0000-0000-000000000009', 'e0000000-0000-0000-0000-000000000001', CURRENT_DATE - 1, TIME '08:00', TIME '16:00', 'Morning shift', NOW(), NOW()),
('ws000000-0000-0000-0000-000000000002', 0, 'f0000000-0000-0000-0000-000000000009', 'e0000000-0000-0000-0000-000000000001', CURRENT_DATE, TIME '09:00', TIME '17:00', 'Test shift for today', NOW(), NOW()),
('ws000000-0000-0000-0000-000000000003', 0, 'f0000000-0000-0000-0000-000000000009', 'e0000000-0000-0000-0000-000000000001', CURRENT_DATE + 1, TIME '10:00', TIME '18:00', 'Evening shift', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
