...
('p0000000-0000-0000-0000-000000000013', 0, 'KITCHEN_ORDER_READ',  NOW(), NOW()),
('p0000000-0000-0000-0000-000000000014', 0, 'KITCHEN_ITEM_ACCEPT', NOW(), NOW()),
('p0000000-0000-0000-0000-000000000015', 0, 'KITCHEN_ITEM_UPDATE', NOW(), NOW()),
('p0000000-0000-0000-0000-000000000016', 0, 'KITCHEN_ITEM_CANCEL', NOW(), NOW())
ON CONFLICT (permission_name) DO NOTHING;
...
-- CHEF: order read + update + KDS kitchen permissions
INSERT INTO org_roles_org_permissions (org_role_id, org_permissions_id) VALUES
...
('r0000000-0000-0000-0000-000000000005', 'p0000000-0000-0000-0000-000000000016')
ON CONFLICT DO NOTHING;
